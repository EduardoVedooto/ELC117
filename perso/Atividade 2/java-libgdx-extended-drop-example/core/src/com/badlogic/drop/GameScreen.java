/* 
 *	As mudanças que foram feitas para adicionar o contador de gotas perdidas estão nas linhas: 
 *  - linha 42: foi criado a variável do tipo inteiro dropsMissed para servir como contador de gotas perdidas.
 *  - Linha 90: aqui é criado o texto que será exposto na tela, mostrando a contagem de gotas.
 *  - Linha 125: aqui é feito a contagem das gotas que não passaram pelo balde (as quais foram perdidas).
*/
...
public class GameScreen implements Screen {
	...
	public void render(float delta) {
		...
		game.font.draw(game.batch, "Drops Missed: " + dropsMissed, 0, 420);
